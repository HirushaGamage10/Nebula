...
<?php $__env->startSection('title', 'NEBULA | Program Administrator (Level 02) Trainee Dashboard'); ?>
        ...
        <div class="dashboard-header">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="mb-0 opacity-75">Welcome back, <?php echo e($user->name); ?> <span class="badge-trainee">TRAINEE</span></p>
                </div>
                <div class="text-end">
                    <div class="text-white-50 small"><?php echo e(now()->format('l, F j, Y')); ?></div>
                    <div class="fs-5 fw-bold"><?php echo e(now()->format('h:i A')); ?></div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('inc.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\thisali\Desktop\thisali\Nebula\resources\views/dashboards/program_admin_l2_trainee.blade.php ENDPATH**/ ?>