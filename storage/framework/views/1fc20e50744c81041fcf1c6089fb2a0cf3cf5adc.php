...
<script>
    ...
    document.getElementById('nicSearchForm').addEventListener('submit', function(e){
        ...
        $.ajax({
            type:'POST',
            url:'<?php echo e(route("student_management.retrieve.details")); ?>',
    ...
    document.getElementById('otherInformationForm').addEventListener('submit',function(e){
        ...
        $.ajax({
            type:'POST',
            url:'<?php echo e(route("student_management.store.other.informations")); ?>',
            data:fd,
            processData:false,
            contentType:false,
            success:function(res){
...
<?php echo $__env->make('inc.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\thisali\Desktop\thisali\Nebula\resources\views/student_management/student_other_information.blade.php ENDPATH**/ ?>