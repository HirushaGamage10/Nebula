...
<?php $__env->startSection('title', 'NEBULA | Program Administrator Dashboard'); ?>
...
<div class="container-fluid">
    ...
    <div class="row mb-4">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
    <a href="<?php echo e(route('payment.summary')); ?>" style="text-decoration: none;">
                ...
                <div class="card-body">
                    ...
                    <div class="row g-3">
                        <div class="col-md-3 col-sm-6">
                            <a href="<?php echo e(route('student.registration')); ?>" class="text-decoration-none">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <a href="<?php echo e(route('course.registration')); ?>" class="text-decoration-none">
                                <div class="p-3 bg-light rounded text-center">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <a href="<?php echo e(route('payment.plan')); ?>" class="text-decoration-none">
                                <div class="p-3 bg-light rounded text-center">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <a href="<?php echo e(route('all.clearance.management')); ?>" class="text-decoration-none">
                                <div class="p-3 bg-light rounded text-center">
...
<?php echo $__env->make('inc.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\thisali\Desktop\thisali\Nebula\resources\views/adminl1/dashboard.blade.php ENDPATH**/ ?>