...
<?php $__env->startSection('title', 'NEBULA | Edit Semester'); ?>
...
<div class="container-fluid">
    <div class="card">
        <div class="card-body">
            ...
            <hr>
            <form action="<?php echo e(route('semesters.update', $semester)); ?>" method="POST" id="semesterEditForm">
                <?php echo csrf_field(); ?>
                ...
                <div class="mb-3 row mx-3">
                    ...
                    <div class="col-sm-10">
                        <select name="location" id="location" class="form-select" required>
                            ...
                            <option value="Welisara" <?php echo e($semester->intake->location === 'Welisara' ? 'selected' : ''); ?>>Nebula Institute of Technology - Welisara</option>
                            <option value="Moratuwa" <?php echo e($semester->intake->location === 'Moratuwa' ? 'selected' : ''); ?>>Nebula Institute of Technology - Moratuwa</option>
                            <option value="Peradeniya" <?php echo e($semester->intake->location === 'Peradeniya' ? 'selected' : ''); ?>>Nebula Institute of Technology - Peradeniya</option>
                        </select>
                    </div>
                </div>
                <div class="mb-3 row mx-3">
                    ...
                    <div class="col-sm-10">
                        <select name="course_id" id="course_id" class="form-select" required>
                            ...
                            <?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($course->course_id); ?>" <?php echo e($semester->course_id == $course->course_id ? 'selected' : ''); ?>>
                    ...
                    <div class="col-sm-10">
                        <select name="intake_id" id="intake_id" class="form-select" required>
                            ...
                            <?php $__currentLoopData = $intakes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $intake): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($intake->intake_id); ?>" <?php echo e($semester->intake_id == $intake->intake_id ? 'selected' : ''); ?>>
                                    <?php echo e($intake->batch); ?>
                ...
                <div class="mb-3 row mx-3">
                    ...
                    <div class="col-sm-10">
                        <select name="semester" id="semester" class="form-select" required>
                            ...
                            <option value="<?php echo e($semester->id); ?>" selected><?php echo e($semester->name); ?></option>
                        </select>
                    </div>
                </div>
                <div class="mb-3 row mx-3">
                    ...
                    <div class="col-sm-10">
                        <input type="date" name="start_date" id="start_date" class="form-control" value="<?php echo e($semester->start_date ? (is_string($semester->start_date) ? \Carbon\Carbon::parse($semester->start_date)->format('Y-m-d') : $semester->start_date->format('Y-m-d')) : ''); ?>" required>
                    </div>
                </div>
                <div class="mb-3 row mx-3">
                    <label for="end_date" class="col-sm-2 col-form-label">End Date <span class="text-danger">*</span></label>
                    <div class="col-sm-10">
                        <input type="date" name="end_date" id="end_date" class="form-control" value="<?php echo e($semester->end_date ? (is_string($semester->end_date) ? \Carbon\Carbon::parse($semester->end_date)->format('Y-m-d') : $semester->end_date->format('Y-m-d')) : ''); ?>" required>
                    </div>
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="text-muted">This will create a copy of "<?php echo e($semester->name); ?>" with all its modules and settings.</p>
                <div class="mb-3">
...
const existingModules = <?php echo json_encode($semesterModules, 15, 512) ?>;
const semesterModules = <?php echo json_encode($semester->modules, 15, 512) ?>;
...
document.addEventListener('DOMContentLoaded', function() {
        ...
        existingModules.forEach(semesterModule => {
            ...
            if (module) {
                const moduleData = {
                    ...
                    semester: <?php echo e($semester->id); ?>,
                ...
                let rowHtml = `<td><?php echo e($semester->name); ?></td>`;
    ...
    document.getElementById('duplicateSemesterBtn').addEventListener('click', function() {
        ...
        fetch('<?php echo e(route("semesters.duplicate", $semester)); ?>', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
...
<?php echo $__env->make('inc.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\thisali\Desktop\thisali\Nebula\resources\views/courses_&_modules/semester_edit.blade.php ENDPATH**/ ?>