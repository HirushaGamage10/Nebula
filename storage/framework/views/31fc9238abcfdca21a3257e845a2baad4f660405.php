                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="<?php echo e(route('payment.index')); ?>" class="btn btn-primary" target="_blank">
...
async function searchStudent(nic) {
    ...
    try {
        ...
        const response = await fetch("<?php echo e(route('course.change.find.student')); ?>", {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
...
async function checkPaymentStatus(registrationId) {
    try {
        ...
        console.log('Sending request to:', "<?php echo e(route('course.change.check.payment')); ?>");
        console.log('CSRF Token exists:', !!document.querySelector('meta[name="csrf-token"]')?.content);
        
        const response = await fetch("<?php echo e(route('course.change.check.payment')); ?>", {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]')?.content || '<?php echo e(csrf_token()); ?>'
...
async function loadCourses() {
    ...
    try {
        const response = await fetch("<?php echo e(route('course.change.courses')); ?>");
...
document.getElementById('course_select').addEventListener('change', async function() {
    ...
    try {
        const response = await fetch("<?php echo e(route('course.change.new.intakes')); ?>", {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
...
async function generateNewId() {
    ...
    try {
        const response = await fetch("<?php echo e(route('course.change.generateId')); ?>", {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
...
async function submitChange() {
    ...
    try {
        const response = await fetch("<?php echo e(route('course.change.submit')); ?>", {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('Check payment route:', "<?php echo e(route('course.change.check.payment')); ?>");
});
</script>
...
<?php echo $__env->make('inc.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\thisali\Desktop\thisali\Nebula\resources\views/registration/course_change.blade.php ENDPATH**/ ?>