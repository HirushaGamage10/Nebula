              ...
              <div class="col-lg-6 mb-4 phase-container" data-phase-id="{{ $phase->id }}">
                <div class="border rounded-3 p-3 bg-light h-100">
                  ...
                  <h6 class="fw-semibold text-secondary mb-2">
                    ...
                    <span class="badge bg-primary rounded-pill ms-1">{{ $phase->teams->count() }}</span>
                  </h6>
                        ...
                        <div class="card border-0 shadow-sm h-100 team-member-card mb-2">
                          <div class="card-body p-2 d-flex flex-column">
                            <div class="d-flex flex-column align-items-center text-center">
                                ...
                                <!-- Member Info -->
                                <h6 class="fw-semibold mb-0 text-dark" style="font-size: 0.8rem;">{{ $team->name }}</h6>
                                <small class="text-muted mb-2" style="font-size: 0.7rem;">{{ $team->p_no ?? 'No contact' }}</small>
                                ...
                                <div class="mb-2">
                                    @foreach($team->roles as $role)
                                        ...
                                        @endphp
                                        <span class="badge bg-{{ $badgeColor }} me-1 mb-1 text-uppercase" style="font-size: 0.55rem; padding: 0.15em 0.3em;">{{ $role->role }}</span>
                                    @endforeach
                                </div>
                            </div>
                            ...
                            <div class="modal-body">
                              ...
                              <div class="text-center mb-3">
                                ...
                                @foreach ($team->roles as $r)
                                  ...
                                  @endphp
                                  <span class="badge bg-{{ $badgeColor }}">{{ $r->role }}</span>
                                @endforeach
                              </div>
                            ...
                            <form method="POST" action="{{ route('team.update', $team) }}" enctype="multipart/form-data">
                              ...
                              <div class="modal-body">
                                ...
                                <div class="mb-3">
                                  ...
                                  <div class="d-flex flex-wrap gap-3">
                                    @foreach(['Leader','Developer','BA','QA','DevOps','Mentor','Freelance'] as $role)
                                      <div class="form-check">
                  ...
                  <div class="mt-4 pt-3 border-top">
                    <h6 class="fw-semibold text-secondary mb-2">
                      ...
                      <span class="badge bg-success rounded-pill ms-1">{{ count($phase->supervisors) }}</span>
                    </h6>
                    <div class="row g-1">
                          ...
                          <div class="card-body py-1 px-2">
                            <div class="d-flex justify-content-between align-items-start">
                              <div class="flex-grow-1">
                                <h6 class="mb-0 fw-semibold text-dark" style="font-size: 0.75rem; line-height: 1.1;">{{ $supervisor['name'] }}</h6>
                        ...
                        <div class="modal-body">
                          ...
                          <div class="row mb-3">
                            <div class="col-md-6">
                              ...
                              <input type="date" name="start_date" class="form-control" value="{{ \Carbon\Carbon::parse($phase->start_date)->format('Y-m-d') }}" required>
                            </div>
                            <div class="col-md-6">
                              <label class="form-label">End Date</label>
                              <input type="date" name="end_date" class="form-control" value="{{ \Carbon\Carbon::parse($phase->end_date)->format('Y-m-d') }}" required>
                            </div>
                          </div>
