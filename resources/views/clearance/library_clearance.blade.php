                    ...
                    <form method="GET" class="row g-3 align-items-end mb-4">
                        <div class="col-md-4">
                            ...
                            <select class="form-select" id="locationFilter" name="location">
                                ...
                                @foreach(['Welisara', 'Moratuwa', 'Peradeniya'] as $location)
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select" id="courseFilter" name="course_id">
                                ...
                                @foreach($courses as $course)
                                    <option value="{{ $course->course_id }}" data-location="{{ $course->location }}" @selected((string) ($filters['course_id'] ?? '') === (string) $course->course_id)>{{ $course->course_name }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-md-3">
                            ...
                            <select class="form-select" id="intakeFilter" name="intake_id">
                                ...
                                @foreach($intakes as $intake)
                                    <option value="{{ $intake->intake_id }}" data-course-id="{{ $intake->course_id }}" data-location="{{ $intake->location }}" @selected((string) ($filters['intake_id'] ?? '') === (string) $intake->intake_id)>{{ $intake->batch }}</option>
                                @endforeach
                            </select>
                        </div>
