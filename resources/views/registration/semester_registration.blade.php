...
@section('content')
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form id="courseForm" method="POST" action="{{ route('semester.registration.store') }}">
                    ...
                    <div class="mb-3 row mx-3">
                        <label for="intake_id" class="col-sm-2 col-form-label">Intake <span
                                class="text-danger">*</span></label>
                        <div class="col-sm-10">
                    ...
                    <div class="mb-3 row mx-3">
                        <label for="semester_id" class="col-sm-2 col-form-label">Semester <span
                                class="text-danger">*</span></label>
                        <div class="col-sm-10">
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.getElementById('courseForm').addEventListener('submit', function (e) {
               ...
               document.querySelectorAll('#students_table tbody tr').forEach(row => {
                    ...
                    // Only add rows with valid status values
                    if (studentId && allowedStatuses.includes(status)) {
                        selectedStudents.push({
                            student_id: studentId,
                            status: status,
                            original_status: (row.dataset.originalStatus || '').trim().toLowerCase()
                        });
                    }
                });
    ...
    <div class="modal fade" id="clearanceCheckModal" tabindex="-1" aria-labelledby="clearanceCheckModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>The selected student has one or more clearance records. Please review them before terminating. Do you
